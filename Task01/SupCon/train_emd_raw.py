...
def prepare_data(
    ...
    # Use all data for training set
    train_idx = np.arange(len(filenames))
...
def main():
    ...
    config = {
        ...
        "learning_rate": 1e-4,
        "random_state": 42,
        "results_dir": "results_emd_augmented_onlyemd_final_full",
        "num_workers": 2,
        "wandb_project": "lisa2025-ordinal-fullemd-augmented-full",
        "model_params": {
            "num_classes": 3,
            "spatial_dims": 3,
            "in_channels": 1,
