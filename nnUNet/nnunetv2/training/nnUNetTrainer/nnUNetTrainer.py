...
from nnunetv2.training.data_augmentation.custom_transforms.fft_clahe import FourierHighFreqTransform, CLAHE3DTransform
...
class nnUNetTrainer(object):
    ...
    def get_training_transforms(
        ...
        # custom probabilistic transforms
        transforms.append(RandomTransform(
            FourierHighFreqTransform(blend_factor=0.7, cutoff=0.05),
            apply_probability=0.3
        ))
        transforms.append(RandomTransform(
            CLAHE3DTransform(clip_limit=2.0),
            apply_probability=0.3
        ))
